        ...
        >
          ...
          <div className="relative w-full h-full flex items-center justify-center scale-75 md:scale-100">
            ...
            >
              ...
              <div className="w-40 h-40 md:w-56 md:h-56 glass-card rounded-[2rem] border-brand-purple/40 shadow-[0_0_50px_rgba(0,229,255,0.3)] relative flex items-center justify-center overflow-hidden">
            ...
            <motion.div 
              ...
              className="absolute top-0 right-10 w-4 h-4 bg-brand-purple rounded-full shadow-[0_0_20px_#00E5FF]"
            />

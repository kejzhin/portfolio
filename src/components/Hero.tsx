      ...
      <div className="w-full max-w-7xl relative z-10 flex flex-col md:grid md:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        >
          <div className="space-y-2 md:space-y-4">
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-black leading-[1.1] tracking-tighter min-h-[2.1em] font-mono">
              <TypewriterSequence phrases={["Hi!", "I'm Jeric", "Cybersecurity\nExpert", "Creative\nDesigner"]} />
            </h1>
            <div className="space-y-4">
              ...
              >
                Web Penetration Tester & Graphics Designer
              </motion.p>
              <motion.p
              ...
              >
                Specializing in bridging the gap between robust digital security and striking visual aesthetics. I help organizations harden their infrastructure against cyber threats while crafting compelling brand identities that stand out in the digital landscape.
              </motion.p>
            </div>
          </div>

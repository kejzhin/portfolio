        ...
        >
          <div className="space-y-2 md:space-y-4">
            ...
            <div className="space-y-4">
              ...
              >
                Based in the intersection of cybersecurity and creativity. I offer professional penetration testing services to secure digital assets, combined with innovative graphic design to build memorable brand experiences globally.
              </motion.p>
            </div>
          </div>

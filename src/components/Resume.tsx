...
import { Download, Briefcase, ShieldCheck, Cpu } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-8 pl-4 border-l border-white/5">
                {experiences.map((exp, idx) => (
                  ...
                  >
                    <div className="absolute -left-[21px] top-2 w-2 h-2 rounded-full bg-brand-purple shadow-[0_0_10px_#00E5FF]" />
          ...
          <div className="space-y-6">
            ...
            <div className="relative h-56 flex items-center justify-center overflow-hidden rounded-3xl bg-black/40 border border-white/5 shadow-inner">
              ...
              {[0, 1, 2].map((i) => (
                ...
                >
                  <motion.div 
                    ...
                    className="absolute -top-1 left-1/2 w-1.5 h-1.5 bg-brand-purple rounded-full shadow-[0_0_8px_#00E5FF]" 
                  />
                </motion.div>
              ))}
              ...
              >
                <div className="w-20 h-20 bg-brand-purple/20 backdrop-blur-md rounded-2xl flex items-center justify-center border border-brand-purple/30 shadow-[0_0_30px_rgba(0,229,255,0.2)]">

        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="aspect-square overflow-hidden bg-white/5 relative flex items-center justify-center">
              ...
              <div className="absolute inset-0 bg-[linear-gradient(rgba(139,92,246,0.03)_1px,transparent_1px)] bg-[size:100%_3px] pointer-events-none" />
            </div>
          ...
          >
            ...
            {[...graphicsProjects, ...graphicsProjects].map((graphic, index) => (
              <motion.div
                ...
                className="w-[240px] flex-shrink-0 group relative bg-[#0A0A0A] border border-white/5 rounded-2xl overflow-hidden hover:border-brand-pink/30 hover:shadow-[0_20px_50px_rgba(255,46,144,0.1)] transition-all duration-500 cursor-pointer"
              >

    ...
    <div id="about" className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-2">
      ...
      >
        <div className="max-w-3xl">
          <div className="bento-label mb-4 md:mb-8">My Specialization</div>
          <p className="text-xl md:text-4xl font-bold leading-tight text-white mb-4 md:mb-8">
          ...
          <div className="h-px w-20 bg-brand-purple/20 mb-4 md:mb-8" />
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        className="md:col-span-3 mt-6 mb-2"
      >
      ...
      <motion.div 
        ...
        className="bento-card flex-row items-center gap-6 py-6 cursor-default transition-colors hover:border-brand-purple/30"
      >
        ...
        <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center border border-white/10 overflow-hidden p-2 shrink-0">
          <img src="https://raw.githubusercontent.com/kejzhin/portfolio/refs/heads/main/image/auro.png" alt="Aurora A. Logo" className="w-full h-full object-contain" />
        </div>
      </motion.div>
      ...
      <motion.div 
        ...
        className="bento-card flex-row items-center gap-6 py-6 border-brand-purple/20 bg-brand-purple/5 cursor-default transition-colors hover:bg-brand-purple/10"
      >
        <div className="flex-1 text-left">
        ...
        <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center border border-brand-purple/20 overflow-hidden p-1 shrink-0">
          <img src="https://raw.githubusercontent.com/kejzhin/portfolio/refs/heads/main/image/carlos.png" alt="Carlos L. Logo" className="w-full h-full object-contain" />
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center border border-white/10 overflow-hidden shrink-0">
          <img src="https://raw.githubusercontent.com/kejzhin/portfolio/refs/heads/main/image/ama.png" alt="AMA Logo" className="w-full h-full object-contain" />
        </div>
      </motion.div>
    </div>
  );

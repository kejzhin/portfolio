  ...
  return (
    ...
    >
      <NavLink to="/" className="flex items-center gap-3 z-[110] relative hover:opacity-80 transition-opacity">
        <div className="w-8 h-8 rounded-lg bg-brand-purple/20 border border-brand-purple/30 flex items-center justify-center shadow-[0_0_15px_rgba(139,92,246,0.2)]">

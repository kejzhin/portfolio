...
export default function Navbar() {
  ...
  return (
    ...
    >
      <NavLink to="/" className="flex items-center gap-3 z-[110] relative hover:opacity-80 transition-opacity">
        <div className="w-8 h-8 rounded-lg bg-brand-purple/20 border border-brand-purple/30 flex items-center justify-center shadow-[0_0_15px_rgba(0,229,255,0.2)]">
            ...
            {({ isActive }) => (
              <>
                ...
                >
                  {[...Array(3)].map((_, i) => (
                    <motion.div 
                      ...
                      className="absolute bottom-0 left-0 right-0 h-[1px] bg-brand-purple shadow-[0_0_12px_#00E5FF,0_0_20px_#00E5FF]" 
                      style={{ 
                        bottom: `${i * 2 - 1}px`,
                        opacity: 0.3 + (i * 0.2)
                      }}
                ...
                {isActive && (
                  <motion.div 
                    layoutId="nav-active"
                    className="absolute -bottom-1 left-0 right-0 h-[2px] bg-brand-purple shadow-[0_0_10px_#00E5FF]"
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-[300px] max-w-[85vw] bg-black border-l border-white/20 z-[90] flex flex-col p-6 pt-20 md:hidden shadow-[-20px_0_100px_rgba(0,0,0,1)]"
            >
                    ...
                    <NavLink 
                      ...
                      className={({ isActive }) => 
                        `group relative flex items-center justify-between px-6 py-5 transition-all border overflow-hidden ${
                          isActive 
                            ? 'bg-brand-purple/10 border-brand-purple/40 text-white shadow-[inset_0_0_25px_rgba(0,229,255,0.15)]' 
                      ...
                      {({ isActive }) => {
                        return (
                          <>
                            ...
                            <div className={`absolute left-0 top-0 bottom-0 w-1 bg-brand-purple transition-all duration-300 shadow-[0_0_15px_rgba(0,229,255,0.6)] ${isActive ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}`} />
                            ...
                            <div className="flex items-center gap-3 relative z-10">
                              {isActive ? (
                                <div className="flex flex-col items-end gap-1">
                                  <div className="w-1.5 h-1.5 bg-brand-purple rounded-full animate-pulse shadow-[0_0_8px_rgba(0,229,255,1)]" />

  ...
  return (
    <div className="space-y-8 md:space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {contactDetails.map((contact, index) => (
          <motion.a
            ...
            className="group relative p-6 md:p-10 bg-[#0A0A0A] border border-white/5 rounded-[2rem] overflow-hidden hover:border-brand-purple/20 transition-all duration-500"
          >
            <div className="relative z-10 flex flex-col h-full">
              <div 
                className="w-12 h-12 rounded-2xl flex items-center justify-center mb-6 md:mb-10 transition-transform duration-500 group-hover:scale-110"
      ...
      <motion.div
        ...
        className="p-6 md:p-12 bg-white/[0.02] border border-white/5 rounded-[2rem] md:rounded-[3rem] text-center"
      >
        <p className="text-white/40 font-mono text-xs uppercase tracking-[0.4em] mb-4">Urgent Inquiries</p>
        <p className="text-lg md:text-2xl font-light text-white/80 max-w-2xl mx-auto mb-6 md:mb-8">

    ...
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      ...
      >
        <svg width="300" height="300" viewBox="0 0 100 100">
           <path d="M50 1L95 25V75L50 99L5 75V25L50 1Z" fill="none" stroke="#8B5CF6" strokeWidth="0.3" />
           <path d="M50 20L80 35V65L50 80L20 65V35L50 20Z" fill="none" stroke="#8B5CF6" strokeWidth="0.1" />
        </svg>
      </motion.div>
      ...
      >
        <svg width="400" height="400" viewBox="0 0 100 100">
           <circle cx="50" cy="50" r="48" fill="none" stroke="#8B5CF6" strokeWidth="0.1" strokeDasharray="3 3" />
           <circle cx="50" cy="50" r="30" fill="none" stroke="#8B5CF6" strokeWidth="0.05" />
        </svg>
      </motion.div>
      ...
      <motion.div 
        animate={{ y: ['-100%', '350%'] }}
        transition={{ duration: 15, repeat: Infinity, ease: 'linear' }}
        className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-brand-purple/60 to-transparent shadow-[0_0_20px_rgba(139,92,246,0.3)]"
      />
      <motion.div 
        animate={{ y: ['350%', '-100%'] }}
        transition={{ duration: 25, repeat: Infinity, ease: 'linear' }}
        className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-brand-pink/40 to-transparent opacity-30 shadow-[0_0_20px_rgba(236,72,153,0.2)]"
      />
